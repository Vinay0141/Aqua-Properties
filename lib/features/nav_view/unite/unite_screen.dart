              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      columnSpacing: 8,
                      // Reduced column spacing for compactness
                      columns: const [
                          ...
                          cells: [
                            ...
                            DataCell(ConstrainedBox(
                              constraints: const BoxConstraints(
                                maxWidth:
                                    80, // Adjust width to control wrapping
                              ),
                              child: SingleChildScrollView(
                                scrollDirection: Axis.vertical,
                                child: Text(unitData.projectId ?? 'N/A'),
                              ),
                            )),
